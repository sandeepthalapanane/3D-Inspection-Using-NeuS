...
class NeuSRenderer:
    ...
    def render_core(self,
                    ...
                    background_rgb=None,
                    cos_anneal_ratio=0.0, intrinsics=None, intrinsics_inv=None, poses=None, images=None):
        batch_size, n_samples = z_vals.shape
    ...
    def render(self, rays_o, rays_d, near, far, perturb_overwrite=-1, background_rgb=None, cos_anneal_ratio=0.0, intrinsics=None, intrinsics_inv=None, poses=None, images=None):
        ...
        ret_fine = self.render_core(rays_o,
                                    ...
                                    cos_anneal_ratio=cos_anneal_ratio, intrinsics=intrinsics, intrinsics_inv=intrinsics_inv, poses=poses, images=images
        )
